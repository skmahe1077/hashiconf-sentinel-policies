...
# This Sentinel policy set is based on the FSBP Policy Set for AWS Terraform v1.1.1
policy "ec2-security-group-ingress-traffic-restriction-to-common-ports" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/FSBP-Policy-Set-for-AWS-Terraform/1.1.1/policy/ec2-security-group-ingress-traffic-restriction-to-common-ports.sentinel?checksum=sha256:adf6f35aa9814b14e311429000cba4a2a755b798e391fd66ffdaaaecf438a4d8"
  enforcement_level = "advisory"
}

policy "ec2-instance-should-not-have-public-ip" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/FSBP-Policy-Set-for-AWS-Terraform/1.1.1/policy/ec2-instance-should-not-have-public-ip.sentinel?checksum=sha256:14261273828ea26ed043bf97bd7fa4617770d181b0890812014f719f065aeab8"
  enforcement_level = "advisory"
}
